...
-- Expressions
parsetoast (PNode Expr [PNode Val [v], PNode TwoOp [t], PNode Expr [e]])    = TwoOpT (parsetoast v) (getTokenString (t)) (parsetoast e)
...
parsetoast (PNode Expr [PNode Brackets [PNode Expr e]])                     = BracketsT (parsetoast(PNode Expr e))
